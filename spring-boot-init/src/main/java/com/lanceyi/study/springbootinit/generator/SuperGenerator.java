...
public class SuperGenerator {
    ...
    protected PackageConfig getPackageConfig() {
        return new PackageConfig()
                .setParent("com.lanceyi.study.springbootinit")
    ...
    protected StrategyConfig getStrategyConfig(String tableName) {
        ...
        return new StrategyConfig()
                ...
                //自定义实体父类
                // .setSuperEntityClass("com.lanceyi.framework.model.BaseModel")
                // 自定义实体，公共字段
                .setSuperEntityColumns("id")
                .setTableFillList(tableFillList)
                // 自定义 mapper 父类
                // .setSuperMapperClass("com.lanceyi.framework.mapper.BaseMapper")
                // 自定义 controller 父类
                // .setSuperControllerClass("com.lanceyi.framework.controller.SuperController")
                // 自定义 service 实现类父类
                // .setSuperServiceImplClass("com.lanceyi.framework.service.impl.BaseServiceImpl")
                // 自定义 service 接口父类
                // .setSuperServiceClass("com.lanceyi.framework.service.BaseService")
