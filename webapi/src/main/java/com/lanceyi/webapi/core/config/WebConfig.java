...
import com.lanceyi.webapi.core.exception.ServiceException;
import com.lanceyi.webapi.core.wrap.WrapEnum;
...
public class WebConfig extends WebMvcConfigurationSupport {
    ...
    private HandlerExceptionResolver getHandlerExceptionResolver() {
        HandlerExceptionResolver handlerExceptionResolver = new HandlerExceptionResolver() {
            ...
            public ModelAndView resolveException(HttpServletRequest request, HttpServletResponse response,
                ...
                WrapResult<Object> result = getResuleByHeandleException(request, handler, e);
     ...
     * @return
     */
    private WrapResult<Object> getResuleByHeandleException(HttpServletRequest request, Object handler, Exception e) {
        WrapResult<Object> result = new WrapResult<>();
        if (e instanceof ServiceException) {
            return WrapResult.wrapResult(WrapEnum.FAILURE);
        }
        if (e instanceof NoHandlerFoundException) {
            result.setCode(WrapEnum.FAILURE.getCode());
     ...
     * @Reutrn void
     */
    private void responseResult(HttpServletResponse response, WrapResult<Object> result) {
